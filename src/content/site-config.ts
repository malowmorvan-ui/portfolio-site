/**
 * Static content for the site. Edit this file directly (no CMS needed for
 * this part) — name, bio, tools, contact info shown on the "/info" page and
 * the site title/header.
 */
